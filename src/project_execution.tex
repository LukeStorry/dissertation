...
\subsection{Testing Four Alternatives}
...
By measuring the differences in acceleration, this statistic works in much the same way as finding the average squared "jerk", ie the derivative of the acceleration.
...
% Loads of issues with trying to open a file browser in android but the importer is working fully in windows - looked into SimpleFileBrowser asset
...
Added more text and clearer button names for remote testing where i am not present
...
This Play Store listing can be seen \href{here}{https://play.google.com/store/apps/details?id=com.lukestorry.augKlimb}, with a screenshot in figure~\ref{fig:playstore}.
...
This caused my amount of testers who were regularly using and testing the app to increase from 4 to 15, providing a rich variety of feedback from regular users of all abilities, both through occasional conversations and through the feedback form I had linked to the homepage of the app.




\section{Final UI Improvements from Tests}
Having more testers, each using the app slightly differently, on an assortment of different devices highlighted a range of small bugs that were either non-existent or at least infrequent on my own devices.
Non-reproducability of some of the bugs made for some tough fixing, but 
...
\subsection{Colour-Grading the Graphs}

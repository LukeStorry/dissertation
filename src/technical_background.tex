...
\subsubsection{Marker-Based Motion Detection}
...
ClimbAX \cite{climbaxstudy} is a similar system that uses wearable acceleronmeter-recording bands on all four limbs, over a series of climbing sessions.
